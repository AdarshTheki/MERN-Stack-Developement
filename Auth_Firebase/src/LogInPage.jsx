  ...
  return (
    <div className='flex flex-col items-center justify-center gap-5'>
      ...
      <form
        ...
        className='flex items-center bg-neutral rounded-lg w-1/2 py-5 mx-auto justify-center flex-col gap-5'>
        <Input
          label='Email: '
      ...
      <button className='btn btn-secondary w-1/3' onClick={Popup}>
        SignIn with Popup
      </button>
      <button className='btn btn-natural w-1/3' onClick={Redirect}>
